        ...
        <div class="w-full max-w-md overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-xl border border-slate-200 dark:border-slate-800">
            <div class="h-32 w-full bg-gradient-to-br from-primary to-indigo-700 relative overflow-hidden">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                    ...
                    <p class="text-sm text-indigo-100">Daftar untuk menggunakan layanan komplain</p>
                </div>
            </div>
            ...
            <div class="p-8">
                <form class="space-y-6" method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-3 pl-11 pr-12 text-slate-900 dark:text-white focus:border-primary focus:ring-primary/20 transition-all outline-none" id="email" name="email" placeholder="name@gmail.com" required="" type="email"/>
                        </div>
                    </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Sudah punya akun? 
                        <a class="font-semibold text-primary hover:underline transition-all" href="{{ url('/login') }}">Login Sekarang</a>
                    </p>
                </div>
            </div>
        </div>
