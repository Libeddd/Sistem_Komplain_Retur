...
<head>
    ...
    <title>Detail Komplain - Pending</title>
            ...
            <div class="flex items-center justify-between mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">ID Komplain: #CMP-9280 / Pesanan: ORD-2026-X102</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    <span class="px-3 py-1.5 rounded-full bg-amber-100 text-amber-600 text-xs font-bold uppercase tracking-widest flex items-center gap-1">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="px-3 py-1.5 rounded-lg bg-red-100 text-red-600 text-xs font-bold border border-red-200">Barang Rusak : Pecah</span>
                        </div>
                        <div class="bg-slate-50 dark:bg-slate-800 p-4 rounded-lg border border-slate-100 dark:border-slate-700">
                            <p class="text-slate-600 dark:text-slate-300 italic text-sm">"Layar monitor retak di pojok kiri bawah dan tidak mau menyala sama sekali."</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between"><span class="text-slate-500">Nama:</span><span class="font-bold">Amelia Putri</span></div>
                            <div class="flex justify-between border-b pb-3"><span class="text-slate-500">Email:</span><span class="font-bold">ameliap20@gmail.com</span></div>
                            
                            <div class="pt-2">
                                <p class="text-lg font-bold mb-4">Detail Refund</p>
                                <div class="bg-slate-50 dark:bg-slate-800 p-3 rounded-xl space-y-2 border border-slate-100 dark:border-slate-700">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-bold text-xs">Transfer Bank (BCA)</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 text-xs">No. Akun:</span>
                                        <span class="font-bold text-xs">0147880635037</span>
                                    </div>
                                    <div class="flex justify-between pt-2 border-t border-slate-200 dark:border-slate-600">
                                        ...
                                        <span class="text-primary font-black">Rp80.000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="action-buttons" class="space-y-3 mt-8">
                            <button onclick="setujuiKomplain()" class="w-full py-3.5 bg-emerald-600 text-white rounded-xl font-bold shadow-lg hover:bg-emerald-700 transition-all">Setujui Retur (Approve)</button>
                            <button onclick="tampilkanFormTolak()" class="w-full py-3.5 border-2 border-red-500 text-red-500 rounded-xl font-bold hover:bg-red-50 transition-all">Tolak Komplain</button>
                        </div>
    ...
    <script>
        function setujuiKomplain() {
            if(confirm("Apakah Anda yakin ingin menyetujui komplain ini?")) {
                ...
                window.location.href = "manajemen-komplain.html"; // Balik ke tabel utama
            }
        }
        ...
        function konfirmasiTolak() {
            ...
            alert("Komplain berhasil ditolak.");
            window.location.href = "manajemen-komplain.html"; // Balik ke tabel utama
        }
    </script>
</body>
