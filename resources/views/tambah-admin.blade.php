...
<head>
    ...
    <title>Tambah Admin - Komplain & Retur</title>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-16 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-8 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-lg font-bold">Tambah Admin</h2>
                </div>
            </div>
        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 pb-20 md:pb-8">
            <div class="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Tambah Akun Admin Baru</h1>
                    <p class="text-sm text-slate-500 mt-1">Buat akun untuk pengelola komplain baru.</p>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('admin.store') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-3 pl-11 pr-4 text-slate-900 dark:text-white focus:border-primary focus:ring-primary/20 transition-all outline-none" id="name" name="name" placeholder="Nama Admin" required type="text"/>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-3 pl-11 pr-4 text-slate-900 dark:text-white focus:border-primary focus:ring-primary/20 transition-all outline-none" id="email" name="email" placeholder="admin@example.com" required type="email"/>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-3 pl-11 pr-4 text-slate-900 dark:text-white focus:border-primary focus:ring-primary/20 transition-all outline-none" id="password" name="password" placeholder="••••••••" required type="password"/>
                        </div>
                        <p class="text-xs text-slate-500 mt-1">Minimal 3 karakter.</p>
                    </div>
