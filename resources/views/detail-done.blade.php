...
<head>
    ...
    <title>Detail Komplain - Done</title>
            ...
            <div class="flex items-center justify-between mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">ID Komplain: #CMP-9265 / Pesanan: ORD-2026-B992</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    <span class="px-3 py-1.5 rounded-full bg-emerald-100 text-emerald-600 text-xs font-bold uppercase tracking-widest flex items-center gap-1">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
                        ...
                        <div class="bg-slate-50 dark:bg-slate-800 p-4 rounded-lg border border-slate-100 dark:border-slate-700">
                            <p class="text-slate-600 dark:text-slate-300 italic text-sm">"Pesan kursi warna hitam, tapi yang datang warna putih."</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                   ...
                   <div class="space-y-3 text-sm">
                            <div class="flex justify-between"><span class="text-slate-500">Nama:</span><span class="font-bold">Eka Putri</span></div>
                            <div class="flex justify-between border-b pb-3"><span class="text-slate-500">Email:</span><span class="font-bold">ekaptr12@gmail.com</span></div>
                            ...
                            <div class="pt-2">
                                ...
                                <div class="bg-slate-50 dark:bg-slate-800 p-3 rounded-xl space-y-2 border border-slate-100 dark:border-slate-700">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-bold text-xs">GoPay (E-Wallet)</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 text-xs">No. Akun:</span>
                                        <span class="font-bold text-xs">081234060962</span>
                                    </div>
                                    <div class="flex justify-between pt-2 border-t border-slate-200 dark:border-slate-600">
                                        ...
                                        <span class="text-primary font-black">Rp70.000</span>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-xl">
                            <h4 class="text-sm font-bold text-emerald-800 mb-1 flex items-center gap-1">
                                <span class="material-symbols-outlined text-[18px]">price_check</span> Dana Dikembalikan
                            </h4>
                            <p class="text-sm text-emerald-600">Proses retur selesai. Pengembalian dana (Refund) telah berhasil ditransfer ke Gopay milik customer.</p>
                        </div>
                    </div>
                </div>
            </div>
